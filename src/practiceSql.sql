...
VALUES
    ...
    ('It', 'USA', '1986-09-15', 600, 'HORROR', 3, 1, 3),
...
-- 3.1900-1935 жылдардын арасындагы китептер чыксын.
...
select name,country,published_year,price ,genre from books where genre not in ('ROMANTIC') and price < 500;
...
-- 20.2010-2015 жылдардын арасындагы китептердин авторлорунун толук
-- аты-жону жана алардын тапкан акчаларынын жалпы суммасы чыксын.
